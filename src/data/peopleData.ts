...
export const INITIAL_PEOPLE: ManagedPerson[] = [
  // 1. ADMINISTRACIÓN GENERAL
  {
    ...
    eventHistory: [
      ...
      { id: 'ev-ij-3', date: '2026-07-29T09:00:00Z', user: 'Israel Jordá', action: 'Equipo asignado', detail: 'Asignación como 2º Entrenador en Alevín E (UUID: b1000001-0000-4000-8000-000000000019) y Benjamín A (UUID: b1000001-0000-4000-8000-000000000023).' }
    ],
  ...
  },
  {
    ...
    eventHistory: [
      ...
      { id: 'ev-rg-2', date: '2025-09-01T10:00:00Z', user: 'Josep Ferrer', action: 'Equipos asignados', detail: 'Asignado como 1º Entrenador de Infantil A (UUID: b1000001-0000-4000-8000-000000000009) y Benjamín A (UUID: b1000001-0000-4000-8000-000000000023).' }
    ],
    createdAt: '2025-09-01T08:00:00Z',
  ...
  // 4. ENTRENADORES REALES (ENTRENADORES 2026 PDF)
  {
    ...
    eventHistory: [
      ...
      { id: 'ev-rf-2', date: '2025-09-01T09:00:00Z', user: 'Josep Ferrer', action: 'Equipos asignados', detail: 'Asignado a Prebenjamín A (UUID: b1000001-0000-4000-8000-000000000028), Alevín E (UUID: b1000001-0000-4000-8000-000000000019) e Infantil A (UUID: b1000001-0000-4000-8000-000000000009).' }
    ],
    createdAt: '2024-09-01T08:00:00Z',
